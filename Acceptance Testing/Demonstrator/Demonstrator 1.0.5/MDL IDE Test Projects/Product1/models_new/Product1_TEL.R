...
#' Initialisation
#' =========================
mdlEditorHome= "C:/mats_working_files/SEE-new/MDL_IDE/";
projectPath="workspace/Product1/";
setwd(mdlEditorHome)

#' Set working directory
setwd("workspace/Product1/models_new")
...
setwd(mdlEditorHome)
setwd(projectPath)
base <- estimate("models_new/Warfarin-ODE-latest.mdl", target="PsN", subfolder="Base")
setwd(mdlEditorHome)
setwd(projectPath)
bootSO <- bootstrap.PsN("models_new/Base/Warfarin-ODE-latest.mdl",samples=20, seed=1234, bootstrapOptions=" -threads=5")
setwd(mdlEditorHome)
setwd(projectPath)
vpcSO <- VPC.PsN("models_new/Base/Warfarin-ODE-latest.mdl",samples=20, seed=1234, vpcOptions=" -threads=5")
setwd(mdlEditorHome)
setwd(projectPath)
sseSO <- SSE.PsN("models_new/Base/Warfarin-ODE-latest.mdl",samples=20, seed=1234, sseOptions=" -no-estimate_simulation -threads=5")
