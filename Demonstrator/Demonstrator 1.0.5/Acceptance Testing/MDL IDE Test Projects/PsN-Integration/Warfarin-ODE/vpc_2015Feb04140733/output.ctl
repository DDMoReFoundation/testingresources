...
; Target	: NMTRAN 7.2.0
; Model 	: output
; Dated 	: Wed Feb 04 14:06:59 GMT 2015

$PROBLEM "output - generated by MDL2PharmML v.6.0"
...
$THETA
( 0.0010 , 0.132779 )	;POP_CL
( 0.0010 , 8.14751 )	;POP_V
( 0.0010 , 1.78924 )	;POP_KA
( 0.0010 , 0.874897 )	;POP_TLAG
( 0.106388 )	;RUV_PROP
( -1.35376E-15 )	;RUV_ADD
( 0.75  FIX )	;BETA_CL_WT
( 1.0  FIX )	;BETA_V_WT
...
( 0.262728 )	;PPV_CL
( 0.2345 )	;CORR_PPV_CL_V
( 0.136931 )	;PPV_V

$OMEGA
( 0.993333 SD )	;PPV_KA
( 0.313633 SD )	;PPV_TLAG
